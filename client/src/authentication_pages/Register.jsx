  ...
  return (
    <div className='flex flex-col lg:flex-row justify-center lg:justify-start min-h-screen'>
      ...
      <div className='flex flex-col justify-center items-center w-full lg:w-1/2 min-h-screen lg:min-h-0 p-4'>
        ...
        <h1 className='text-3xl font-bold mb-8 lg:block md:hidden sm:hidden text-[#207dff] text-shadow-[5px_5px_5px_rgba(0,191,255,1)]'>Register</h1>
        <img 
          src={image2} 
          alt="Edulens Logo" 
        ...
        <form className='flex flex-col w-full max-w-sm md:max-w-md' method='POST'>
          ...
          <h2 className='font-tasa-orbiter pt-2 text-shadow-[5px_5px_5px_rgba(0,191,255,1)]'>Already Have An Account? <a href='#' className='text-blue-500'>Login</a></h2>
        </form>
      </div>
    </div>
  );
