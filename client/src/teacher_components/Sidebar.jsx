import { Home, Settings, ChevronLeft, ChevronRight, LayoutDashboard, FileText, FileQuestion, BookOpen, Sparkles } from 'lucide-react'
...
const Sidebar = () => {
    ...
    const menuItems = [
        { name: "Dashboard", icon: LayoutDashboard, path: "/teacher_dashboard" },
        { name: "AI Tools", icon: Sparkles, path: "/teacher-ai-tools" },
